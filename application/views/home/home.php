          ...
          <div class="container">
            <div class="header-wrap">
              <div class="header-top d-flex justify-content-between align-items-center">
                <div class="logo">
                  <a href="index.html" class=""><h6 class="text-white text-uppercase">Laundry</h6> </a>
                </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="single-feature">
                <div class="thumb" style="background: url(<?php echo base_url('assets_home/') ?>img/t1.jpg);"></div>
            ...
            <div class="col-md-4">
              <div class="single-feature">
                <div class="thumb" style="background: url(<?php echo base_url('assets_home/') ?>img/t2.jpg);"></div>
                <div class="desc text-center mt-30">
            ...
            <div class="col-md-4">
              <div class="single-feature">
                <div class="thumb" style="background: url(<?php echo base_url('assets_home/') ?>img/t3.jpg);"></div>
                <div class="desc text-center mt-30">
        ...
        <div class="container">
          ...
          <div class="single-remark">
            <div class="row no-gutters">
              <div class="col-lg-7 col-md-6">
                <div class="remark-thumb" style="background: url(<?php echo base_url('assets_home/') ?>img/r1.jpg);"></div>
              </div>
          ...
          <div class="single-remark">
            <div class="row no-gutters">
              ...
              <div class="col-lg-5 col-md-6">
                <div class="remark-thumb" style="background: url(<?php echo base_url('assets_home/') ?>img/r2.jpg);"></div>
              </div>
            </div>
          </div>
          <div class="single-remark">
            <div class="row no-gutters">
              <div class="col-lg-7 col-md-6">
                <div class="remark-thumb" style="background: url(<?php echo base_url('assets_home/') ?>img/r3.jpg);"></div>
              </div>
              <div class="col-lg-5 col-md-6">
                <div class="remark-desc">
                  <h4>Vector Illustration</h4>
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="section-title">
                <h3>Antar Sekarang
                <span>Pilih Parfume dan Jenis</span>
              </div>
            </div>
            <div class="col-lg-6">
        ...
        <footer>
          <div class="container">
            <div class="footer-content d-flex justify-content-between align-items-center flex-wrap">
              <div class="logo">
                <a href="index.html"><img src="<?php echo base_url('assets_home/') ?>img/logo.png" alt=""></a>
              </div>

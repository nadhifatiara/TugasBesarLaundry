...
<main role="main" class="container">
	...
	<form action="<?php echo base_url('perfume/ubah/'.$getData['perfume_id']); ?>" method="post">
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="perfume_name" class="form-control" id="perfume_name"  value="<?php echo $getData['perfume_name'] ?>" placeholder="perfume name">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="perfume_costperkilo" class="form-control" id="perfume_costperkilo"  value="<?php echo $getData['perfume_costperkilo'] ?>" placeholder="perfume costperkilo">

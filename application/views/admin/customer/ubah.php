...
<main role="main" class="container">
	...
	<?php echo form_open_multipart('customer/ubah/'.$getData['customer_id']); ?>
	<div class="form-group row">
		<label for="customer_firstname" class="col-sm-2 col-form-label">First Name</label>
		<div class="col-sm-10">
			<input type="text" name="customer_firstname" class="form-control" id="customer_firstname"  value="<?php echo $getData['customer_firstname'] ?>" placeholder="customer_firstname">
	...
	<div class="form-group row">
		...
		<div class="col-sm-10">
			<input type="text" name="customer_lastname" class="form-control" id="customer_lastname"  value="<?php echo $getData['customer_lastname'] ?>" placeholder="customer_lastname">
			<?php echo form_error('customer_lastname') ?> <!-- menampilkan error saat rule customer_lastname gagal -->
		</div>
	</div>
	<div class="form-group row">
		<label for="customer_address" class="col-sm-2 col-form-label">Address</label>
		<div class="col-sm-10">
			<input type="text" name="customer_address" class="form-control" id="customer_address"  value="<?php echo $getData['customer_address'] ?>" placeholder="customer_address">
	...
	<div class="form-group row">
		...
		<div class="col-sm-10">
			<input type="text" name="customer_telp" class="form-control" id="customer_telp"  value="<?php echo $getData['customer_telp'] ?>" placeholder="customer_telp">
	...
	<div class="form-group row">
		...
		<div class="col-sm-10">
			<input type="text" name="customer_email" class="form-control" id="customer_email"  value="<?php echo $getData['customer_email'] ?>" placeholder="customer_email">
	...
	<div class="form-group row">
		...
		<div class="col-sm-10">
			<input type="text" name="customer_password" class="form-control" id="customer_password"  value="<?php echo $getData['customer_password'] ?>" placeholder="customer_password">
